...
Example:
    python wofost_brp.py 2020 barley -v -p zeeland -f
"""
import fpcup
...
parser.add_argument("year", help="year to load the BRP for", type=int)
...
if __name__ == "__main__":
    ...
    # Load the BRP file
    brp = fpcup.io.load_brp(args.year)
    if args.verbose:
        print(f"Loaded BRP data for {args.year} -- {len(brp)} sites")
